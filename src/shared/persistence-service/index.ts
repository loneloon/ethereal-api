...
> {
    ...
    protected abstract modelAccessor: PrismaModelDelegate & { create: any, findMany: any, findUnique: any, update: any, delete: any }
    protected abstract isPrimaryKeyComposite: boolean
    
    abstract prismaClient: PrismaClientType
    
    protected async createEntity(createEntityInputDto: CreateEntityInputDto): Promise<EntityDto | null>{
    ...
    protected async getUniqueEntity(primaryKeyFieldName: string, primaryKeyValue: string | { [key: string]: any;}): Promise<EntityDto | null> {
        if (this.isPrimaryKeyComposite && typeof primaryKeyValue === "string") {
            console.warn(JSON.stringify({
                ...
                expectedTypeOfPrimaryKey: this.isPrimaryKeyComposite ? "COMPOSITE" : "STRING",
     ...
     */
    protected async deleteEntity(primaryKeyFieldName: string, primaryKeyValue: string | { [key: string]: any;}): Promise<EntityDto | null> {
        console.warn(JSON.stringify(
            {
