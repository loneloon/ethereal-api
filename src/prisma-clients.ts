...
const clients = {
  aupClient: new PrismaAupClient({
    datasources: { db: { url: process.env.AUP_DATABASE_URL } },
  }),
  ssdClient: new PrismaSsdClient({
    datasources: { db: { url: process.env.SSD_DATABASE_URL } },
  }),
};
